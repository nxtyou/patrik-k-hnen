      ...
      <Swiper className="h-[90vh]">
        {slidesContent.map(({ title, subtitle, customer, year }, i) => (
          <SwiperSlide key={i}>
            ...
            <div className="absolute bottom-[7%] px-6 sm:px-8 md:bottom-[15%] md:w-4/5 md:px-20 xl:px-32">
              <div className="max-w-xl">
                <img src="/images/logos/sky.svg" alt="" width="95" height="57" />
                <h1 className="mt-4 font-poppins text-4xl font-medium md:text-6xl">{title}</h1>
